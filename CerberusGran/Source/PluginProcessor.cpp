...
bool CerberusGranAudioProcessor::loadSampleFile (const juce::File& file)
{
...
bool CerberusGranAudioProcessor::savePresetToFile (const juce::File& file)
{
    if (file == juce::File())
        return false;
...
bool CerberusGranAudioProcessor::loadPresetFromFile (const juce::File& file)
{
